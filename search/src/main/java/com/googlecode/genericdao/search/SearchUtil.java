...
public class SearchUtil {
     ...
     * Add a filter that uses the IN operator.
     */
    public static void addFilterIn(IMutableSearch search, String property, Collection<?> value, ZoneId zoneId) {
        addFilter(search, Filter.in(property, value, zoneId));
    }
     ...
     * specified.
     */
    public static void addFilterIn(IMutableSearch search, String property, ZoneId zoneId, Object... value) {
        addFilter(search, Filter.in(property, zoneId, value));
    }
     ...
     * Add a filter that uses the NOT IN operator.
     */
    public static void addFilterNotIn(IMutableSearch search, String property, Collection<?> value, ZoneId zoneId) {
        addFilter(search, Filter.notIn(property, value, zoneId));
    }
     ...
     * specified.
     */
    public static void addFilterNotIn(IMutableSearch search, String property, ZoneId zoneId, Object... value) {
        addFilter(search, Filter.notIn(property, zoneId, value));
    }
